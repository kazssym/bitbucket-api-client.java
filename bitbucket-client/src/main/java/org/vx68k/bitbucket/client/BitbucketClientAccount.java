 ...
 * @since 6.0.0
 */
public abstract class BitbucketClientAccount implements BitbucketAccount
{
    /**
     ...
     */
    public BitbucketClientAccount(final BitbucketClientAccount other)
    {
     ...
     */
    public BitbucketClientAccount(final JsonObject json)
    {
        if (json == null) {
